                        ...
                        <div class="col-xl-12 col-md-12">
                            <div class="card shadow mb-4 card-header py-3">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col">
                                        <textarea class="form-control form" type="text" rows="5" placeholder="Napisz kilka słów o tym, co skłoniło Cię do programowania"></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; seneStudio 2021</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
